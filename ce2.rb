...
command_comprehensive = "cat /data1/efl3-tnr-projet/tnr-backup/input-motcle.txt"

# command_extensive = "ls /e8/#{bdd}"
# command_extensive = "ls /u/progs/webbudev/bu"

# command_extensive = "ls /data1/efl3-tnr-projet/tnr-backup/input-meta/*  | sed s/tnr-backup.input-meta/tnr-input/"
command_extensive = "ls /data1/efl3-tnr-projet/tnr-input/*"

setc = Set.new(IO.popen(command_comprehensive).readlines.each)

#sete = Set.new(IO.popen(command_extensive).readlines.each)
# il n'y a pas besoin de chomp : .map(&:chomp)
sete = Set.new(IO.popen(command_extensive).readlines.each)
#sete = Set.new()
#IO.popen(command_extensive).readlines.each { |e| sete << chomp(e) }
